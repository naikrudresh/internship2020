<?php
        ...
        $query="SELECT `username`, `fname`, `lname`,`mail`, `phone`, `ser` FROM `clint` INNER JOIN `services` USING (username)";
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="admin3d.php">3D Print<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item active">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="adminrob.php">Robots</a>
        </li>
      </ul>
